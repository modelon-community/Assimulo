...
def run_example(with_plots=True):
    r"""
    Demonstration of the use of difex1 by solving the
    ...
    exp_mod = Explicit_Problem(f, y0=N.array([4.0]), name = 'difex1 Test Example: $\dot y = - y$')
    #Define an explicit solver
    exp_sim = Difex1(exp_mod) #Create an difex1 solver
