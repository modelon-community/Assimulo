...
try:
    from assimulo.lib import eulsim
except ImportError:
...
####najmeh
        ...
        for tout in output_list:
            ...
            self.statistics["nsteps"]        += eulsim.statp.nstep
            self.statistics["nfcn"]          += eulsim.statp.nfcn
            self.statistics["errfail"]       += eulsim.statp.nrejct 
            self.statistics["nlu"]           += eulsim.statp.ndec
    ...
    def print_statistics(self, verbose=NORMAL):
        ...
        self.log_message('\nSolver options:\n',                                      verbose)
        self.log_message(' Solver                  : eulsim ' + self._type,          verbose)
