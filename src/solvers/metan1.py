...
try:
    from assimulo.lib import metan1
except ImportError:
...
class Metan1(Explicit_ODE):
    ...
    def integrate(self, t, y, tf, opts):
        ...
        for tout in output_list:
            ...
            result=metan1.metan1(self.f,t,y.copy(),tout, self.options["rtol"] , self.options["maxh"] ,self.options["inith"],kflag)
            y=result[1]
            t=result[0]
            H=result[2]
            flag=result[3]
            ...
            self.statistics["nsteps"]        += metan1.statp.nstep
            self.statistics["nfcn"]          += metan1.statp.nfcn
            self.statistics["errfail"]       += metan1.statp.nrejct 
            self.statistics["nlu"]           += metan1.statp.ndec
    ...
    def print_statistics(self, verbose=NORMAL):
        ...
        self.log_message('\nSolver options:\n',                                      verbose)
        self.log_message(' Solver                  : metan1 ' + self._type,          verbose)
